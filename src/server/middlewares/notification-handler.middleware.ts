...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'OrderPlaced.create': { roles: ['owner', 'chef', 'waiter'], key: 'order', tenantPath: [], userPath: [] },
  'OrderPrepared.update': { roles: ['owner', 'waiter'], key: 'order', tenantPath: [], userPath: [] },
  'FeedbackReceived.create': { roles: ['owner'], key: 'feedback', tenantPath: [], userPath: [] },
};
